...
*
*	DESCRIPTION:
*		- Reduce transform stream which computes the quantiles of streamed data.
*
*
*	NOTES:
*		[1] In order to compute the quantiles exactly, all values must be buffered into memory. As a result, this stream is a sink stream, and caution should be used for large datasets. 
*
*
*	TODO:
*		[1] 
